...
class RoleController extends Controller
{
    ...
    {
        $value = Role::orderBy('name', 'DESC')->get();

        return view('roles.index',compact('value'));
    }
    ...
    public function show($id)
    {
        ...
        return view('roles.show',compact('value'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('roles.edit',compact('value','permission','rolePermissions'));
    }
