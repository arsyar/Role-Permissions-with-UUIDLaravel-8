...
class UserController extends Controller
{
    ...
    {
        $value = User::orderBy('name','asc')->get();
        return view('users.index', compact('value'));
    }
    ...
    public function show($id)
    {
        ...
        return view('users.show', compact('value','role'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('users.edit', compact('value', 'role'));
    }
